...
N_TUBAROES = 1  # Apenas 1 tubarão para inferência
PINGS_POR_TUBARAO = (
...
OUTPUT_FILE = "data/inferencia/dados_inferencia.csv"
...
def main():
    ...
    # Estatísticas básicas (sem comportamento e p_forrageio)
    print("Dados de inferência gerados:")
    ...
    print("\nSUCESSO: Dados de inferência gerados com sucesso!")
    print("Dados prontos para inferência de IA (sem labels de comportamento).")
    ...
    print("  - SEM campos de labels (p_forrageio e comportamento removidos)")
